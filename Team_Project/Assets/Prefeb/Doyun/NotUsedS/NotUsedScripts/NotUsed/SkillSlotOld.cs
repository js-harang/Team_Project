...
// 스킬창에서 끌어오는 스킬
public class SkillSlotOld : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler
{
    public SkillDirectoryOld skillPannel;
    ...
    #region 스킬 속성
    [SerializeField] private PlayerAttackOld skill;
