...
namespace RayFire
{
    ...
    public class RayfireMan : MonoBehaviour
    {
        ...
        public static int                        buildMinor           = 69;
        ...
        public static bool                       debugBuildStatic     = true;
        ...
        // Debug message
        public static void Debug (string str, GameObject go = null)
        {
            // Disabled
            ...
            // Only in Debug build
            if (debugBuildStatic == true && UnityEngine.Debug.isDebugBuild == false)
                return;
