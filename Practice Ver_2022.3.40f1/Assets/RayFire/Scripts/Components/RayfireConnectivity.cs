    ...
    public class RayfireConnectivity : MonoBehaviour
    {
        ...
        public void Initialize()
        {
            ...
            if (meshRootHost != null)
            {
                ...
                {
                    // Has no objects
                    RayfireMan.Debug ("RayFire Connectivity: " + name + " has no objects to check for connectivity. Connectivity disabled.", gameObject);
        ...
        bool WarningCheck()
        {
            ...
            if (meshRootHost != null)
            {
                ...
                {
                    RayfireMan.Debug ("RayFire Connectivity: " + name + " object has Rigid host but it's object type is not Mesh Root. Connectivity disabled.", gameObject);
                    return false;
                }
                ...
                {
                    RayfireMan.Debug ("RayFire Connectivity: " + name + " object has Rigid host with Mesh Root type but activation By Connectivity is disabled. ", gameObject);
                    return false;
                }

                if (meshRootHost.simTp != SimType.Inactive && meshRootHost.simTp != SimType.Kinematic)
                {
                    RayfireMan.Debug ("RayFire Connectivity: " + name + " object has Rigid but simulation type is not Inactive or Kinematic. Connectivity disabled. ", gameObject);
                    return false;
                }
            }
            ...
            if (rigidRootHost != null)
            {
                ...
                {
                    RayfireMan.Debug ("RayFire Connectivity: " + name + " object has RigidRoot host but activation By Connectivity is disabled.", gameObject);
                    return false;
                }
                
                if (rigidRootHost.simTp != SimType.Inactive && rigidRootHost.simTp != SimType.Kinematic)
                {
                    RayfireMan.Debug ("RayFire Connectivity: " + name + " object has RigidRoot but simulation type is not Inactive or Kinematic. Connectivity disabled. ", gameObject);
                    return false;
                }
            }
        ...
        void PrepareCluster()
        {
            ...
            {
                RayfireMan.Debug ("RayFire Connectivity: " + name + " object has missing shards. Reset and Editor Setup Connectivity host again.", gameObject);
                cluster            = new RFCluster();
        ...
        HashSet<Collider> GetOverlappedColliders (Collider col)
        {
            ...
            {
                RayfireMan.Debug ("RayFire Connectivity: " + name + ". Fracture Collider is not supported. Use Box or Sphere trigger collider.", gameObject);
            }
