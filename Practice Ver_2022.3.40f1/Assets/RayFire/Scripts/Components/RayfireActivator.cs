    ...
    public class RayfireActivator : MonoBehaviour
    {
        ...
        void SetCollider()
        {
            ...
            if (gizmoType == GizmoType.Collider)
            {
                ...
                if (colliders.Length == 0)
                    RayfireMan.Debug ("RayFire Activator: " + name + " has no activation collider", gameObject);
        ...
        void SetParticleSystem()
        {
            ...
            if (type != ActivationType.OnCollision)
            {
                ...
                RayfireMan.Debug ("Rayfire Activator: " + name + " Particle System Gizmo Type supports only On Collision Activation type. Set Activation Type to On Collision." , gameObject);
            }
        }
        ...
        public void StartAnimation()
        {
            ...
            {
                RayfireMan.Debug ("Position list is empty and scale is not animated");
                return;
            }
        ...
        void SetWorldPointsByLine()
        {
            ...
            if (line == null)
            {
                RayfireMan.Debug ("Path line is not defined");
                return;
            }
        ...
        public void AddPosition (Vector3 newPos)
        {
            ...
            if (ByLine == true)
            {
                RayfireMan.Debug ("Position can be saved only for Global and Local Position animation type.");
                return;
            }
            ...
            {
                RayfireMan.Debug ("Activator at the same position.");
                return;
            }
