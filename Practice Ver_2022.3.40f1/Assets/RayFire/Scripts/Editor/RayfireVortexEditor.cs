...
namespace RayFireEditor
{
    ...
    public class RayfireVortexEditor : Editor
    {
        ...
        void GUI_Anchor()
        {
            GUICommon.Caption (TextVrt.gui_cap_anc);
        ...
        void GUI_Gizmo()
        {
            GUICommon.Caption (TextVrt.gui_cap_giz);
        ...
        void GUI_Eye()
        {
            GUICommon.Caption (TextVrt.gui_cap_eye);
        ...
        void GUI_Strength()
        {
            GUICommon.Caption (TextVrt.gui_cap_str);
        ...
        void GUI_Torque()
        {
            GUICommon.Caption (TextVrt.gui_cap_tor);
        ...
        void GUI_Height()
        {
            GUICommon.Caption (TextVrt.gui_cap_hei);
        ...
        void GUI_Seed()
        {
            GUICommon.Caption (TextVrt.gui_cap_seed);
        ...
        void GUI_Preview()
        {
            GUICommon.Caption (TextVrt.gui_cap_prev);
        ...
        void GUI_Filters()
        {
            GUICommon.Caption (TextVrt.gui_cap_flt);
            

            EditorGUI.BeginChangeCheck();
            string tagFilter = EditorGUILayout.TagField (TextVrt.gui_tag, vortex.tagFilter);
            if (EditorGUI.EndChangeCheck())
            {
                Undo.RecordObjects (targets, TextVrt.gui_tag.text);
            ...
            EditorGUI.BeginChangeCheck();
            int mask = EditorGUILayout.MaskField (TextVrt.gui_lay, vortex.mask, layerNames.ToArray());
            if (EditorGUI.EndChangeCheck())
            {
                Undo.RecordObjects (targets, TextVrt.gui_lay.text);
                foreach (RayfireVortex scr in targets)
                {
                    scr.mask = mask;
                    SetDirty (scr);
