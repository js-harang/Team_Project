...
namespace RayFireEditor
{
    ...
    public class RayfireUnyieldingEditor : Editor
    {
        ...
        void GUI_Properties()
        {
            GUICommon.Caption (TextUny.gui_cap_prp);
        ...
        void GUI_Gizmo()
        {
            GUICommon.Caption (TextUny.gui_cap_giz);
            ...
            bool showCenter = GUILayout.Toggle (uny.showCenter, TextUny.gui_btn_cnt, "Button", GUILayout.Height (22));
            if (EditorGUI.EndChangeCheck())
            {
                Undo.RecordObjects (targets, TextUny.gui_btn_cnt.text);
