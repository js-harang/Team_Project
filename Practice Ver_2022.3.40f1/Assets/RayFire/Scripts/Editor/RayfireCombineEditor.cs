...
namespace RayFireEditor
{
    ...
    public class RayfireCombineEditor : Editor
    {
        ...
        void UI_Source()
        {
            GUICommon.Caption (TextCmb.gui_cap_source);
        ...
        void UI_Filters()
        {
            GUICommon.Caption (TextCmb.gui_cap_filters);
        ...
        void UI_Comb()
        {
            GUICommon.Caption (TextCmb.gui_cap_index);
            GUICommon.PropertyField (sp_indexFormat, TextCmb.gui_indexFormat);
        }

        void UI_Export()
        {
            GUICommon.Caption (TextCmb.gui_cap_export);
