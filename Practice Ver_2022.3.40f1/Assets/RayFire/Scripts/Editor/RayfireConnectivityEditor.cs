...
namespace RayFireEditor
{
    ...
    public class RayfireConnectivityEditor : Editor
    {
        ...
        void GUI_Preview()
        {
            ...
            bool showGizmo = GUILayout.Toggle (conn.showGizmo, TextCnt.gui_btn_gizmo, "Button", GUILayout.Height (25));
            if (EditorGUI.EndChangeCheck() == true)
            {
                Undo.RecordObjects (targets, TextCnt.gui_btn_gizmo.text);
            ...
            EditorGUI.BeginChangeCheck();
            bool showConnections = GUILayout.Toggle (conn.showConnections, TextCnt.gui_btn_cnt, "Button", GUILayout.Height (25));
            if (EditorGUI.EndChangeCheck() == true)
            {
                Undo.RecordObjects (targets, TextCnt.gui_btn_cnt.text);
                foreach (RayfireConnectivity scr in targets)
                {
            ...
            EditorGUI.BeginChangeCheck();
            bool showNodes = GUILayout.Toggle (conn.showNodes, TextCnt.gui_btn_nodes, "Button", GUILayout.Height (25));
            if (EditorGUI.EndChangeCheck() == true)
            {
                Undo.RecordObjects (targets, TextCnt.gui_btn_nodes.text);
                foreach (RayfireConnectivity scr in targets)
                {
        ...
        {
            GUICommon.Caption (TextCnt.gui_cap_conn);
        ...
        void GUI_Cluster()
        {
            GUICommon.Caption (TextCnt.gui_cap_cluster);
        ...
        void GUI_Collapse()
        {
            GUICommon.Caption (TextCnt.gui_cap_collapse);
        ...
        void GUI_Stress()
        {
            GUICommon.Caption (TextCnt.gui_cap_stress);
        ...
        void GUI_Trigger()
        {
            GUICommon.Caption (TextCnt.gui_cap_fracture);
