...
namespace RayFireEditor
{
    ...
    public class RayfireActivatorEditor : Editor
    {
        ...
        void GUI_Components()
        {
            GUICommon.Caption (TextAct.gui_cap_components);
        ...
        void GUI_Gizmo()
        {
            GUICommon.Caption (TextAct.gui_cap_gizmo);
        ...
        void GUI_Activation()
        {
            GUICommon.Caption (TextAct.gui_cap_act);
        ...
        void GUI_Force()
        {
            GUICommon.Caption (TextAct.gui_cap_frc);
        ...
        void GUI_Animation()
        {
            GUICommon.Caption (TextAct.gui_cap_anim);
