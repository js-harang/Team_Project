...
namespace RayFireEditor
{
    ...
    public static class TextGun
    {
        ...
        public static readonly GUIContent gui_cap_filt    = new GUIContent ("      Other",      "");
        public static readonly GUIContent gui_tag         = new GUIContent ("Tag",              "");
        public static readonly GUIContent gui_lay         = new GUIContent ("Layer",            "");
    }
    ...
    public static class TextMan
    {
        ...
        // Tooltips
        const string tlp_ph_cop = "Used only when Planar Check enabled. All meshes with vertices amount less than defined value will perform planar check. If all vertices lay ALMOST on a plane then object will not get collider to avoid convex hull generation errors.";
    ...
    public static class TextFad
    {
        ...
        public static readonly GUIContent gui_fad_dml   = new GUIContent ("On Demolition", "");
        public static readonly GUIContent gui_fad_act   = new GUIContent ("On Activation", "");
        public static readonly GUIContent gui_fad_ofs   = new GUIContent ("By Offset",     "");
        ...
        public static readonly GUIContent gui_fad_tm    = new GUIContent ("Time",          "Fade duration time.");
