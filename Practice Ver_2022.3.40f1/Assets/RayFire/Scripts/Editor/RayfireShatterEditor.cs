...
namespace RayFireEditor
{
    ...
    public class RayfireShatterEditor : Editor
    {
        ...
        void GUI_Types()
        {
            ...
            GUICommon.Caption (TextSht.gui_cap_frg);
        ...
        void GUI_Material()
        {
            ...
            GUICommon.Caption (TextSht.gui_cap_mat);
        ...
        void GUI_Cluster()
        {
            ...
            GUICommon.Caption (TextSht.gui_cap_cls);
        ...
        void GUI_Advanced()
        {
            GUICommon.Caption (TextSht.gui_cap_prp);
            ...
            {
                GUICommon.Caption (TextSht.gui_cap_edt);
        ...
        void GUI_Center()
        {
            if ((int)shat.type <= 5)
            {
                GUICommon.Caption (TextSht.gui_cap_cent);

                GUILayout.BeginHorizontal();
                EditorGUI.BeginChangeCheck();
                bool showCenter = GUILayout.Toggle (shat.showCenter, TextSht.gui_btn_show, "Button");
                if (EditorGUI.EndChangeCheck())
                {
                    Undo.RecordObjects (targets, TextSht.gui_btn_show.text);
