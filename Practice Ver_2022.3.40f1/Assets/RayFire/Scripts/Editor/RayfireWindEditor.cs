...
namespace RayFireEditor
{
    ...
    public class RayfireWindEditor : Editor
    {
        ...
        void GUI_Gizmo()
        {
            GUICommon.Caption (TextWnd.gui_cap_giz);
        ...
        void GUI_Noise()
        {
            GUICommon.Caption (TextWnd.gui_cap_nse);
        ...
        void GUI_Strength()
        {
            GUICommon.Caption (TextWnd.gui_cap_str);
        ...
        void GUI_Direction()
        {
            GUICommon.Caption (TextWnd.gui_cap_dir);
        ...
        void GUI_Preview()
        {
            GUICommon.Caption (TextWnd.gui_cap_prev);
        ...
        void GUI_Filters()
        {
            GUICommon.Caption (TextWnd.gui_cap_flt);
            
            EditorGUI.BeginChangeCheck();
            string tagFilter = EditorGUILayout.TagField (TextWnd.gui_tag, wind.tagFilter);
            if (EditorGUI.EndChangeCheck())
            {
                Undo.RecordObjects (targets, TextWnd.gui_tag.text);
            ...
            EditorGUI.BeginChangeCheck();
            int mask = EditorGUILayout.MaskField (TextWnd.gui_lay, wind.mask, layerNames.ToArray());
            if (EditorGUI.EndChangeCheck())
            {
                Undo.RecordObjects (targets, TextWnd.gui_lay.text);
                foreach (RayfireWind scr in targets)
                {
                    scr.mask = mask;
                    SetDirty (scr);
