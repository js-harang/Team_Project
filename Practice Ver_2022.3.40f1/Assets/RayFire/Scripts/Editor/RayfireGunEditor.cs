...
namespace RayFireEditor
{
    ...
    public class RayfireGunEditor : Editor
    {
        ...
        void GUI_Direction()
        {
            GUICommon.Caption (TextGun.gui_cap_dir);
        ...
        void GUI_Burst()
        {
            GUICommon.Caption (TextGun.gui_cap_bur);
        ...
        void GUI_Impact()
        {
            GUICommon.Caption (TextGun.gui_cap_imp);
        ...
        void GUI_Components()
        {
            GUICommon.Caption (TextGun.gui_cap_comp);
        ...
        void GUI_Damage()
        {
            GUICommon.Caption (TextGun.gui_cap_dmg);
        ...
        void GUI_VFX()
        {
            GUICommon.Caption (TextGun.gui_cap_vfx);
        ...
        void GUI_Filters()
        {
            GUICommon.Caption (TextGun.gui_cap_filt);
            
            EditorGUI.BeginChangeCheck();
            string tagFilter = EditorGUILayout.TagField (TextGun.gui_tag, gun.tagFilter);
            if (EditorGUI.EndChangeCheck())
            {
                Undo.RecordObjects (targets, TextGun.gui_tag.text);
            ...
            EditorGUI.BeginChangeCheck();
            int mask = EditorGUILayout.MaskField (TextGun.gui_lay, gun.mask, layerNames.ToArray());
            if (EditorGUI.EndChangeCheck())
            {
                Undo.RecordObjects (targets, TextGun.gui_lay.text);
                foreach (RayfireGun scr in targets)
                {
                    scr.mask = mask;
                    SetDirty (scr);
