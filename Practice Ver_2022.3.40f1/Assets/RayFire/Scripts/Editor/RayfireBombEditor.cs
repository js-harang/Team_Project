...
namespace RayFireEditor
{
    ...
    public class RayfireBombEditor : Editor
    {
        ...
        void GUI_Range()
        {
            GUICommon.Caption (TextBmb.gui_cap_range);
        ...
        void GUI_Impulse()
        {
            GUICommon.Caption (TextBmb.gui_cap_impulse);
        ...
        void GUI_Activation()
        {
            GUICommon.Caption (TextBmb.gui_cap_act);
        ...
        void GUI_Damage()
        {
            GUICommon.Caption (TextBmb.gui_cap_dmg);
        ...
        void GUI_Detonation()
        {
            GUICommon.Caption (TextBmb.gui_cap_prop);
        ...
        void GUI_Filters()
        {
            ...
            if (fld_fil == true)
            {
                ...
                string tagFilter = EditorGUILayout.TagField (TextBmb.gui_tagFilter, bomb.tagFilter);
                if (EditorGUI.EndChangeCheck())
                {
                    Undo.RecordObjects (targets, TextBmb.gui_tagFilter.text);
                ...
                EditorGUI.BeginChangeCheck();
                int mask = EditorGUILayout.MaskField (TextBmb.gui_mask, bomb.mask, layerNames.ToArray());
                if (EditorGUI.EndChangeCheck())
                {
                    Undo.RecordObjects (targets, TextBmb.gui_mask.text);
                    foreach (RayfireBomb scr in targets)
                    {
                        scr.mask = mask;
                        SetDirty (scr);
